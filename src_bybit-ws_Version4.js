...
class BybitWS extends EventEmitter {
  ...
  subKline(symbol, interval) {
    // Correct Bybit v5 kline topic format: kline.{interval}.{symbol}
    // Some older examples include a 'linear' token (kline.{interval}.linear.{symbol}) — server rejects that.
    // Build the standard topic and subscribe.
