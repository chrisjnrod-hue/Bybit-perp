// scanner.js (updated for seeding state tracking)
// Replace existing src/scanner.js with this file (keeps previous logic, only adds seeding flags and logs)
...
class Scanner extends EventEmitter {
  ...
  async start() {
    ...
    if (SEED_HISTORICAL) {
      // run seeding but don't block forever: await here to initialize indicators before subscribing
